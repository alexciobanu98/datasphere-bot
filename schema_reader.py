...
# === CONFIG ===
DB_USER = "postgres"
DB_PASSWORD = "Admin123"  # ✅ Your working password
DB_HOST = "localhost"
DB_PORT = "5432"
DB_NAME = "my_test_db"
SCHEMA_NAME = "gpm"        # ✅ Targeting the correct schema
...
if __name__ == "__main__":
    ...
    if not schema:
        print("⚠️ No schema found or failed to connect.")
    else:
